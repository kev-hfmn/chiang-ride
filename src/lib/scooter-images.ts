...
const SCOOTER_IMAGES: Record<string, string> = {
  // Honda models
  'honda-click': 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=600&q=80',
  'honda-pcx': 'https://images.unsplash.com/photo-1571188654248-7a89213915f7?w=600&q=80',
  'honda-scoopy': 'https://images.unsplash.com/photo-1609630875171-b1321377ee65?w=600&q=80',
  'honda-forza': 'https://images.unsplash.com/photo-1622185135505-2d795003f6f6?w=600&q=80',
  'honda-adv': 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80',

  // Yamaha models
  'yamaha-nmax': 'https://images.unsplash.com/photo-1580310614729-ccd69652491d?w=600&q=80',
  'yamaha-aerox': 'https://images.unsplash.com/photo-1558980664-769d59546b3d?w=600&q=80',
  'yamaha-filano': 'https://images.unsplash.com/photo-1558981359-219d6364c9c8?w=600&q=80',
  'yamaha-xmax': 'https://images.unsplash.com/photo-1558981285-6f0c94958bb6?w=600&q=80',
  'yamaha-lexi': 'https://images.unsplash.com/photo-1599819811279-d5ad9cccf838?w=600&q=80',

  // Vespa
  'vespa': 'https://images.unsplash.com/photo-1595787572747-c767c9021caf?w=600&q=80',

  // Generic fallbacks by brand
  'honda': 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=600&q=80',
  'yamaha': 'https://images.unsplash.com/photo-1580310614729-ccd69652491d?w=600&q=80',
  'suzuki': 'https://images.unsplash.com/photo-1558980664-769d59546b3d?w=600&q=80',
  'gpx': 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80',

  // Default fallback
  'default': 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=600&q=80',
}
...
export function getScooterImage(brand?: string, model?: string, scooterId?: string): string {
  if (!brand && !model) {
