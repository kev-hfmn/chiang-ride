...
export function ShopDetailView({ shop, scooters }: ShopDetailViewProps) {
  const { t } = useLanguage()
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-4">
          ...
          <div className="bg-gray-50 rounded-2xl p-4 flex gap-3 text-sm text-gray-600">
            ...
            <div>
              <span className="font-bold text-gray-900 block mb-1">{t('depositPolicy')}</span>
      ...
      <div className="space-y-6">
        <h2 className="text-xl font-extrabold text-gray-900">{t('availableBikes')}</h2>
                      ...
                      <div className="flex items-center gap-1">
                        <span
                          className={`w-2 h-2 rounded-full ${
                            scooter.is_active ? 'bg-green-500' : 'bg-red-400'
                          }`}
                        ></span>
